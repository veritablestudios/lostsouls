...
const NFTCard = ({ nft, onProfilePage }) => {
  ...
  return (
    <Link href={{ pathname: "/nft-details", query: nft }}>
      <div
        className="hvr-float-shadow flex-1 min-w-215 max-w-max xs:max-w-none sm:w-full sm:min-w-155 minmd:min-w-256 minlg:min-w-327 bg-nft-black-3 rounded-3xl p-4 m-4 minlg:m-8 sm:my-2 sm:mx-2 cursor-pointer shadow-md"
      >
